...
async function getAIResponse(userMessage) {
    try {
        ...
        const maxTokens = isDetailedQuery ? 2800 : 200;
        ...
        **2️ Key Components of a Solar Panel**
        ...
        **3️ Step-by-Step Process of How Solar Panels Work**
        1️ **Photon Absorption:** Sunlight (photons) hits the photovoltaic (PV) cells.
        2️ **Electron Excitation:** The photons transfer energy to electrons in the silicon, making them move freely.
        3️ **Electric Field Formation:** The PV cells have a built-in electric field that directs electron movement.
        4️ **Direct Current (DC) Generation:** This movement of electrons generates **direct current (DC)** electricity.
        5️ **DC to AC Conversion:** An **inverter** converts DC electricity into **alternating current (AC)**, which is used in homes and businesses.
        6️ **Power Distribution:** The AC electricity is used to power household appliances or sent to the power grid.
        7️ **Energy Storage (If Applicable):** Extra electricity is stored in **solar batteries** for later use.
        8️ **Net Metering (If Connected to Grid):** Excess electricity sent back to the grid earns energy credits.
